...
function NonMemberTop() {
    ...
    const onEnterkeyHandler = e => {
        ...
        if (e.key === 'Enter') {
            navigate(`/admin/nonMember/search?value=${search}`)
        }
    ...
    return(
        <>
            <div className="member-top">
                <div className="member-top-title">미등록 회원 관리</div>
