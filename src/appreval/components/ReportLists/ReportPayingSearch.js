...
import {callReportPayingSearchAPI} from "../../apis/ReportAPICalls";
...
function ReportPayingSearch() {
    ...
    useEffect(() => {
        dispatch(callReportPayingSearchAPI({documentTitle,startDate,endDate,currentPage}));
...
export default ReportPayingSearch;