...
import {callApprovalStatusUpdateAPI, callReportApproveAPI} from "../../apis/ReportAPICalls";
...
function ReportApprove() {
    ...
    const {reportApprove} = useSelector(state => state.approvalReducer);
    ...
    useEffect(() => {
        dispatch(callReportApproveAPI({currentPage}));
    }, [currentPage]);
            ...
            <div className="reportContainer-noRecall">
                ...
                {reportApprove &&
                    <div className="reportTable">
                        ...
                        <ApprovalPagingBar pageInfo={reportApprove.pageInfo} setCurrentPage={setCurrentPage}/>
                    </div>
