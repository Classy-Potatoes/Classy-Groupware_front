...
import {callSignWaitingAPI} from "../../../apis/SignAPICalls";


function SignWaiting() {

    const dispatch = useDispatch();
    const [currentPage, setCurrentPage] = useState(1);
    const {signData} = useSelector(state => state.approvalReducer);
    ...
    useEffect(() => {
        dispatch(callSignWaitingAPI({currentPage}));
    }, [currentPage]);
    ...
    const onClickSearchHandler = e => {
        ...
        navigate(`/approval/sign/search-waiting?documentTitle=${documentTitleSearch}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&page=${currentPage}`);
    }
            ...
            <div className="reportContainer-noRecall">
                ...
                {signData &&
                    <div className="reportTable">
                        ...
                        <ApprovalPagingBar pageInfo={signData.pageInfo} setCurrentPage={setCurrentPage}/>
                    </div>
