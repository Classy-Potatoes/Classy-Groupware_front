...
import {callApprovalStatusUpdateAPI, callReportPayingAPI} from "../../apis/ReportAPICalls";
...
function ReportPaying() {

    const dispatch = useDispatch();
    const [currentPage, setCurrentPage] = useState(1);
    const {reportPaying} = useSelector(state => state.approvalReducer);
    ...
    useEffect(() => {
        dispatch(callReportPayingAPI({currentPage}));
    }, [currentPage]);
    ...
    const onClickSearchHandler = e => {
        ...
        navigate(`/approval/report/search-paying?documentTitle=${documentTitleSearch}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&page=${currentPage}`);
    }
            ...
            <div className="reportContainer-noRecall">
                ...
                {reportPaying &&
                    <div className="reportTable">
                        ...
                        <ApprovalPagingBar pageInfo={reportPaying.pageInfo} setCurrentPage={setCurrentPage}/>
                    </div>
