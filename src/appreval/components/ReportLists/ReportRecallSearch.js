...
import {
    callApprovalStatusUpdateAPI, callReportRecallSearchAPI,
    callReportTurnbackSearchAPI,
...
function ReportRecallSearch() {
    ...
    useEffect(() => {
        dispatch(callReportRecallSearchAPI({documentTitle,startDate,endDate,currentPage}));
...
export default ReportRecallSearch;