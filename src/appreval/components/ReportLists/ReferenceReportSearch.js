...
import {callReportReferenceSearchAPI} from "../../apis/ReportAPICalls";
...
function ReferenceReportSearch() {
    ...
    useEffect(() => {
        dispatch(callReportReferenceSearchAPI({documentTitle,startDate,endDate,currentPage}));
...
export default ReferenceReportSearch;