...
import {callApprovalStatusUpdateAPI, callReportWaitingSearchAPI} from "../../apis/ReportAPICalls";
...
function ReportWaitingSearch() {
    ...
    useEffect(() => {
        dispatch(callReportWaitingSearchAPI({documentTitle,startDate,endDate,currentPage}));
...
export default ReportWaitingSearch;