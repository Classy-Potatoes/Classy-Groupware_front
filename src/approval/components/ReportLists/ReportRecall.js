...
import {callApprovalStatusUpdateAPI, callReportRecallAPI, callReportWaitingAPI} from "../../apis/ReportAPICalls";
...
function ReportRecall() {
    ...
    const {reportRecall} = useSelector(state => state.approvalReducer);
    ...
    useEffect(() => {
        dispatch(callReportRecallAPI({currentPage}));
    }, [currentPage]);
    ...
    const onClickSearchHandler = e => {
        ...
        navigate(`/approval/report/search-recall?documentTitle=${documentTitleSearch}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&page=${currentPage}`);
    }
            ...
            <div className="reportContainer-noRecall">
                ...
                {reportRecall &&
                    <div className="reportTable">
                        ...
                        <ApprovalPagingBar pageInfo={reportRecall.pageInfo} setCurrentPage={setCurrentPage}/>
                    </div>
