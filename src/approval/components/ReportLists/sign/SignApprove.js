...
import {callSignApproveAPI} from "../../../apis/SignAPICalls";
...
function SignApprove() {
    ...
    useEffect(() => {
        dispatch(callSignApproveAPI({currentPage}));
    }, [currentPage]);
    ...
    const onClickSearchHandler = e => {
        ...
        navigate(`/approval/sign/search-approve?documentTitle=${documentTitleSearch}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&page=${currentPage}`);
    }
