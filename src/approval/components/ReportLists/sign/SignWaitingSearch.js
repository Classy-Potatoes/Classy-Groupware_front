...
import {callSignWaitingSearchAPI} from "../../../apis/SignAPICalls";


function SignWaitingSearch() {
    ...
    useEffect(() => {
        dispatch(callSignWaitingSearchAPI({documentTitle,startDate,endDate,currentPage}));
...
export default SignWaitingSearch;